/* jQuery Nice Select - v1.0 - http://hernansartorio.github.io/jquery-nice-select */ ! function(a) {
        ...
        this.each(function() {
            ...
            if(!b.next().hasClass("nice-select")) {
                ...
                c.find(".current").html(e.data("display") || e.text()), d.each(function() {
                    ...
                    c.find("ul").append('<li class="bingc-action-open-passive-form option ' + (a(this).is(":selected") ? "selected" : "") + '" data-value="' + a(this).val() + (b ? '" data-display="' + b : "") + '">' + a(this).text() + "</li>")
                })
            }
