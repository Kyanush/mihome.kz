...
<body>
    ...
    @if(date('d.m.Y') == '27.06.2020' or date('d.m.Y') == '28.06.2020')
        <p style="font-size: 20px;color: red;">
            27 – 28 июня наш магазин работает в ограниченном режиме. Приобрести товар самовывозом возможно только по предварительному заказу.
        </p>
    @endif
